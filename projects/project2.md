...
4. <b>Submit your implementation for Autograder feedback</b>
	- <b>These instructions will be updated and an official announcement will be made via email and [EdStem](/syllabus/#discussion-forum) once the Project 2 Autograder is online.</b>
	<!-- - Once you have implemented a portion of the required features, you may submit your work for feedback from the Autograder. To receive feedback, download your `*.ipynb` and `*.py` files then upload them to the Project 2 Autograder. You may submit to the Autograder for feedback up to 2 times per day. -->
